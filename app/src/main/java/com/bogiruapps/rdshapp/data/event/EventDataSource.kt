...
interface EventDataSource {
    ...
    suspend fun createTaskEvent(region: Region, city: City, school: School, event: SchoolEvent, taskSchoolEvent: TaskSchoolEvent): Result<Void?>

    suspend fun updateTaskEvent(region: Region, city: City, school: School, event: SchoolEvent, taskSchoolEvent: TaskSchoolEvent): Result<Void?>

    suspend fun deleteTaskEvent(region: Region, city: City, school: School, event: SchoolEvent, taskSchoolEvent: TaskSchoolEvent): Result<Void?>
